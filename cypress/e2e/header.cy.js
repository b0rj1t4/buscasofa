...
describe('Visualización del header de la aplicación', () => {
  ...
  it('El usuario ve un enlace a la página de Emergencia', () => {
    cy.get('nav a.emergency')
      .should('exist')
      .should('have.attr', 'href', '/emergency')
      .contains('Emergencia')
      .click();
    cy.url().should('include', '/emergency'); // hemos navegado a la página correctamente
  });
});
